...
class Level extends Game{
    constructor(canvasId){
        super(canvasId);
        const player = new Player(this.canvas.width/2 - 25, this.canvas.height/2);
        ...
        this.addGameObject(new Collectible(250, this.canvas.height - 100));
        this.addGameObject(new Collectible(450, this.canvas.height - 100));
        this.addGameObject(new Collectible(650, this.canvas.height - 100));
    }
